...
df$Syndrome = sample(1:3,prob = pMat[pdS,],n,replace=TRUE) #proportion of syndrome 1,2
...
sdRun = sdSim[sdS]
fun1 = function(t,B0,B1){pnorm(B0+B1*t+rnorm(n=1,mean = 0,sd = sdRun))}
